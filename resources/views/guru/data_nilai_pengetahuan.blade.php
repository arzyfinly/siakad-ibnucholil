...
<div class="col-lg-12">
    <div class="card">
      ...
      <div class="row">
        ...
        <a href="{{route('guru.export_pengetahuan',$mapel_id)}}" target="_blank" class="btn btn-primary">Export Template</a>
        <a href="{{route('guru.cetak_nilai_pengetahuan',$mapel_id)}}" target="_blank" class="btn btn-primary">Cetak Nilai</a>
      </div>
    </div>
  </div>
  <!-- Modal-->
                      ...
                      <div role="document" class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 id="exampleModalLabel" class="modal-title">Import Pengetahuan</h4>
                            <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                          </div>
                          <div class="modal-body">
                            <p>Silahkan tambhakan .</p>
                            <form action="{{route('guru.import_pengetahuan')}}" method="post" enctype="multipart/form-data">
                            @csrf
...
$(function() {
    $('#users-table').DataTable({
      "lengthMenu": [[30, 45, 50, -1], [30, 45, 50, "All"]],
        processing: true,
        serverSide: true,
        ajax: "{{route('guru.json_nilai_pengetahuan',$mapel_id)}}",
        columns: [
