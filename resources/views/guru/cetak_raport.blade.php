...
<table  border="0">
    ...
    <table border="1" width="1000px">
        ...
        <tbody>
        <tr>
            <td colspan="10"><strong>A. Muatan Nasional</strong></td>
        ...
        @endforeach
        <tr>
            <td colspan="10"><strong>B. Muatan Kewilayahan</strong></td>
        </tr>
        @php($nob=0)
        @foreach($data as $datas)
            @foreach($datas->kelas->mapel as $kelompoka)
        ...
        @endforeach
        <tr>
            <td colspan="10"><strong>C. Muatan Peminatan Kejuruan</strong></td>
        </tr>
        <tr>
            <td colspan="10"><strong>C1. Dasar Bidang Keahlian</strong></td>
        </tr>
        @php($noc1=0)
        @foreach($data as $datas)
            @foreach($datas->kelas->mapel as $kelompoka)
        ...
        <tr>
            <td colspan="10"><strong>C2. Dasar Program Keahlian</strong></td>
        </tr>
        @php($noc2=0)
        @foreach($data as $datas)
            @foreach($datas->kelas->mapel as $kelompoka)
        ...
        <tr>
            <td colspan="10"><strong>C3. Kompetensi Keahlian</strong></td>
        </tr>
        @php($noc3=0)
        @foreach($data as $datas)
            @foreach($datas->kelas->mapel as $kelompoka)
        ...
        @endforeach
        <tr>
            <td colspan="10"><strong>MULOK</strong></td>
        </tr>
        @php($nom=0)
        @foreach($data as $datas)
            @foreach($datas->kelas->mapel as $kelompoka)
