...
<div class="col-lg-6 mb-5">
    <div class="card">
      <div class="card-header">
        <h3 class="h6 text-uppercase mb-0">Foto Guru</h3>
      </div>
      <div class="card-body">
        <form id="loginForm" action="{{route('guru.update_foto_guru',$data->id)}}" class="mt-4" method="post" enctype="multipart/form-data">
          @csrf
...
<br>
    <div class="card">
      ...
      <div class="card-body">
        <form id="loginForm" action="{{route('guru.update_tentang_guru',$data->id)}}" class="mt-4" method="post" enctype="multipart/form-data">
          @csrf
 ...
 <div class="col-lg-6 mb-5">
    <div class="card">
      ...
      <div class="card-body">
        <form id="loginForm" action="{{route('guru.update_pendidikan_guru',$data->id)}}" class="mt-4" method="post" enctype="multipart/form-data">
          @csrf
 ...
 <div class="col-lg-6 mb-5">
    <div class="card">
      ...
      <div class="card-body">
        <form id="loginForm" action="{{route('guru.update_lain_guru',$data->id)}}" class="mt-4" method="post" enctype="multipart/form-data">
          @csrf
 ...
 <div class="col-lg-6 mb-5">
    <div class="card">
      ...
      <div class="card-body">
        <form id="loginForm" action="{{route('guru.update_pegawai_guru',$data->id)}}" class="mt-4" method="post" enctype="multipart/form-data">
          @csrf
