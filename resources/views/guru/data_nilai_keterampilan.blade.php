...
<div class="col-lg-12">
    <div class="card">
      ...
      <div class="row">
        ...
        <a href="{{route('guru.export_keterampilan',$mapel_id)}}" target="_blank" class="btn btn-primary">Export Template</a>
        <a href="{{route('guru.cetak_nilai_keterampilan',$mapel_id)}}" target="_blank" class="btn btn-primary">Cetak Nilai</a>
                      ...
                      <div role="document" class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h4 id="exampleModalLabel" class="modal-title">Import Keterampilan</h4>
                            <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                          </div>
                          <div class="modal-body">
                            <p>Silahkan tambhakan .</p>
                            <form action="{{route('guru.import_keterampilan')}}" method="post" enctype="multipart/form-data">
                            @csrf
...
$(function() {
    $('#users-table').DataTable({
      "lengthMenu": [[30, 45, 50, -1], [30, 45, 50, "All"]],
        processing: true,
        serverSide: true,
        ajax: "{{route('guru.json_nilai_keterampilan',$mapel_id)}}",
        columns: [
