...
<div class="col-lg-12">
    <div class="card">
      ...
      <div class="row">
        ...
        <a href="{{route('export_sikap',$mapel_id)}}" target="_blank" class="btn btn-primary">Export Template</a>
        <a href="{{route('cetak_nilai_sikap',$mapel_id)}}" target="_blank" class="btn btn-primary">Cetak Nilai</a>
      </div>
    </div>
  </div>
  <!-- Modal-->
                      ...
                      <div role="document" class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="{{route('import_sikap')}}" method="post" enctype="multipart/form-data">
                            @csrf
...
$(function() {
    $('#users-table').DataTable({
      "lengthMenu": [[30, 45, 50, -1], [30, 45, 50, "All"]],
        processing: true,
        serverSide: true,
        ajax: "{{route('json_nilai_sikap',$mapel_id)}}",
        columns: [
