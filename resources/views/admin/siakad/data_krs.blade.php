...
<div class="col-lg-12">
    <div class="card">
      ...
      <div class="row">
        ...
        <br>
        <a href="{{route('pilih_siswa',[$kelas_id,$data->ket,$semester])}}" target="_blank" class="btn btn-primary" style="margin-top:5px;">Pilih siswa</a>
...
$(function() {
    $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{route('json_krs',['id'=>$kelas_id,'semester'=>$semester])}}",
        columns: [
