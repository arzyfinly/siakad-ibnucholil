                      ...
                      <div role="document" class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="{{route('input_eskul')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label>Nilai *</label>
                                <input type="number" name="nilai" class="form-control" required placeholder="Nilai..">
                              </div>
                              <div class="form-group">
