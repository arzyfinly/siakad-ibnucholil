                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            @csrf
                              ...
                              <div class="form-group">
                                <input type="text" name="jurusan_id" id="" value="{{$jurusan_id}}" hidden>
...
$(function() {
    $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{route('json_kelas_jurusan',['id'=>$jurusan_id,'tahun'=>$tahun_ajaran])}}",
        columns: [
...
$(document).ready(function(){
  jQuery.ajax ({
    url: "{{route('json_tahun_ajaran',$jurusan_id)}}",
    dataType: "json",
    success: function(response) {
      console.log(response.data);
      var content = response.data;
      for (let i = 0; i < content.length; i++) {
          ...
          $("#tahun").append('<option value="'+content[i].id+'" selected>'+content[i].tahun+'</option>');
          }else{
          $("#tahun").append('<option value="'+content[i].id+'">'+content[i].tahun+'</option>');
          }
      }
